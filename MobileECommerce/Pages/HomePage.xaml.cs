...
public partial class HomePage : ContentPage
{
    ...
    private void CvMaisVendidos_SelectionChanged(object sender,
        SelectionChangedEventArgs e)
    {
    ...
    private void CvPopulares_SelectionChanged(object sender,
        SelectionChangedEventArgs e)
    {
        if (sender is CollectionView collectionView)
        {
    ...
    private void NavigateToProdutoDetalhesPage(CollectionView collectionView,
        SelectionChangedEventArgs e)
    {
        ...
        Navigation.PushAsync(new ProdutoDetalhesPage(
            currentSelection.Id, currentSelection.Name!,
